  ...
  useEffect(() => {
    ...
    if(window.google) {
      ...
      google.accounts.id.renderButton(
        ...
        {theme: 'outline', type: 'icon', size: 'large', shape: 'square'}
      )
    }
          ...
          <div className="w-full bg-white rounded-lg shadow  md:mt-0 sm:max-w-md xl:p-0">
              <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                  ...
                  <div className="flex mt-4 gap-x-2">
                    ...
                    <button onClick={getGitHubUrl} className="flex items-center justify-center w-full p-2 border border-gray-600 rounded-md focus:ring-2 focus:ring-offset-1 focus:ring-violet-600">
                        <svg
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 32 32"
                  ...
                  <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit(onSubmit)}>
                      <div>
                          ...
                          {errors.email?.type === "required" && <p className='text-red-500 text-sm mt-1' role="alert">Email Address is required</p>}
                          {errors.email?.type === "pattern" && <p className='text-red-500 text-sm mt-1' role="alert">Email is not valid</p> }
                          { onerrors?.email && <p className='text-red-500 text-sm mt-1' role="alert">{onerrors?.email}</p> }
                      ...
                      <div>
                          ...
                          { onerrors?.password && <p className='text-red-500 text-sm mt-1' role="alert">{onerrors?.password}</p> }
                      ...
                      <button type="submit" className="w-full inline-block shrink-0 rounded-md border border-blue-600 bg-blue-600 px-12 py-3 text-sm font-medium text-white transition hover:bg-transparent hover:text-blue-600 focus:outline-none focus:ring active:text-blue-500">Sign in</button>
